...
def calcular_euft(df, dias_uteis_mes):
    df['Data de Partida'] = pd.to_datetime(df['Data de Partida'], format='%d/%m/%Y', errors='coerse')
    df['Data de Retorno'] = pd.to_datetime(df['Data de Retorno'], format='%d/%m/%Y', errors='coerse')
